...
<div class="data-card" style="max-width:720px">
  ...
  <form method="post" style="display:grid;gap:12px;padding:8px 4px 16px">
    ...
    <div>
      ...
      <input class="form-control" name="featured_image" value="<?= h((string) ($_POST['featured_image'] ?? '')) ?>" placeholder="https://..." />
    </div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
      ...
      <div>
        ...
        <input class="form-control" name="tag_label" value="<?= h((string) ($_POST['tag_label'] ?? '')) ?>" />
      </div>
    </div>
    <div>
      <label class="cell-muted" style="font-size:0.8rem">Từ khóa tìm kiếm</label>
      <input class="form-control" name="keywords" value="<?= h((string) ($_POST['keywords'] ?? '')) ?>" />
    </div>
    <div>
