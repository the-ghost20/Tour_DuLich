...
$pageTitle    = 'Đặt tour';
$pageSubtitle = 'Danh sách đơn đặt trong hệ thống';
$activePage   = 'bookings';

$exportUrl = htmlspecialchars(app_admin_url('bookings/export.php'), ENT_QUOTES, 'UTF-8');
$topbarActions = <<<HTML
  <a href="{$exportUrl}" class="topbar-btn topbar-btn-ghost"><i class="fas fa-file-csv"></i> Xuất CSV</a>
HTML;
