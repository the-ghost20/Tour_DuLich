...
CREATE TABLE `tours` (
  ...
  `journey_intro` MEDIUMTEXT NULL DEFAULT NULL,
  `highlights` MEDIUMTEXT NULL DEFAULT NULL,
  `departure_schedule` MEDIUMTEXT NULL DEFAULT NULL,
  ...
  `gallery_urls` MEDIUMTEXT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `blog_posts` (
  ...
  `tag_label` VARCHAR(160) NULL DEFAULT NULL,
  `keywords` VARCHAR(400) NULL DEFAULT NULL,
